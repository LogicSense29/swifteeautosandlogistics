      ...
      <div className="section-container relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-24 flex flex-col items-center">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-fluid-h2 mb-10 leading-tight"
          >
          ...
          {features.map((feature, idx) => (
            <MagneticEffect key={idx} strength={0.2}>
              <motion.div
                ...
                data-cursor="pointer"
                className="relative bg-white dark:bg-white/[0.03] p-12 rounded-[3.5rem] shadow-3xl shadow-black/5 border border-slate-100 dark:border-white/10 overflow-hidden group transition-all duration-700"
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-last justify-between mb-12">
                    <span className="text-6xl font-black text-slate-100 dark:text-white/5 group-hover:text-brand-orange/20 transition-colors duration-700 leading-none">
                      {feature.number}
                    </span>
                  ...
                  <h3 className="text-3xl font-black mb-6 tracking-tight group-hover:text-brand-blue transition-colors duration-500">{feature.title}</h3>
                  <p className="text-muted-foreground leading-relaxed text-lg font-medium group-hover:text-foreground transition-colors duration-500">
                    {feature.desc}
                  </p>
