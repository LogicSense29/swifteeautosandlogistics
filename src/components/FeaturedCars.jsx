  ...
  return (
    <section ref={containerRef} className="relative z-10 -mt-8 md:-mt-14 pb-20">
      ...
      <div className="section-container relative z-10">
        ...
        {/* Glassmorphic Container for Horizontal Scroll */}
        <div className="relative bg-white/10 dark:bg-black/40 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-[2.5rem] p-6 md:p-10 shadow-2xl overflow-hidden">
          
          {/* Decorative Noise/Grain */}
          <div className="absolute inset-0 opacity-5 pointer-events-none noise-overlay"></div>
          
           {/* Section Header - integrated inside glass container */}
            ...
            <div className="flex gap-6 w-max flex-nowrap">
              {cars.map((car, index) => (
                <motion.div
                  ...
                  className="group w-[250px] md:w-[320px] flex-shrink-0 snap-center"
                >
                  {/* Simple Clean Card */}
                  <div className="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-[2rem] overflow-hidden hover:border-brand-orange dark:hover:border-brand-orange transition-all duration-300 shadow-sm hover:shadow-xl h-full">
                    ...
                    <div className="p-5 md:p-6">
                      ...
                      {/* Price */}
                      <div className="mb-3 md:mb-4 pb-3 md:pb-4 border-b border-slate-200 dark:border-white/10">
                        <span className="text-2xl md:text-3xl font-black text-brand-orange">{car.price}</span>
                      </div>
